...
public class CustomTenantConfigResolver implements TenantConfigResolver {
    ...
    public OidcTenantConfig resolve(RoutingContext context) {
        ...
        if ("articlesA".equals(parts[1])) {
            ...
            config.setAuthServerUrl("https://us-south.appid.cloud.ibm.com/oauth/v4/a7ec8ce4-3602-42c7-8e88-6f8a9db31935");
            config.setClientId("b3adeb3b-36fc-40cb-9bc3-dd6f15047195");
